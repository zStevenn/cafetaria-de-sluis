...
const UnderConstruction = () => {
	return (
		<div className="bg-neutral-100 w-screen h-[70vh] flex items-center justify-center">
			<div className="text-center text-neutral-700 text-xl font-semibold">
				...
				<Link
					to="/"
					className="text-neutral-100 p-4 bg-secondary rounded-lg hover:scale-110 transition-all"
				>
