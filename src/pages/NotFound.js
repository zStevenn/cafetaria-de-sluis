...
export default function NotFound() {
	...
	return(
		<div className="flex flex-col bg-green h-screen justify-center items-center text-center text-white">
		...
		<a href="/" className="px-4 py-6 bg-white border-white rounded-full mt-2 text-green font-bold">Terug naar homepagina</a>
      		</div>
	);
}
