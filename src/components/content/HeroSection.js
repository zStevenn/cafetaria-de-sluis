...
function HeroSection() {
	return (
		<div className="flex flex-col justify-center p-2 md:flex-row h-[40vh] relative">
			<div class="waves-top hidden md:flex">
				<svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
					<path d="M1200 120L0 16.48 0 0 1200 0 1200 120z" className="shape-fill"></path>
				</svg>
			</div>
			<div class="waves-bottom hidden md:flex">
				<svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
			...
			<div className="flex flex-1 flex-col justify-center content-center text-center">
				...
				<div className="mb-4 mt-6">
					<a href="https://www.e-food.nl/driebergen/cafeteria-de-sluis" className="btn-primary font-semibold">
						Bestel nu online!
					</a>
				</div>
			</div>
