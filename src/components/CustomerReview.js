...
export default function ReviewList() {
	return (
		<div className="flex flex-col justify-center items-center bg-white">
			<div className="">
				<p className="text-3xl font-bold m-2">Reviews</p>
			</div>
			<div className="flex flex-row flex-nowrap justify-center items-center">
			<ArrowLeft className="text-3xl fill-primary" />
			<ReviewCard name={"Steven Li"} rating={2} />
			<ReviewCard name={"Superman"} rating={4} />
			<ArrowRight className="text-3xl fill-primary" />
			</div>
		</div>
	);
}