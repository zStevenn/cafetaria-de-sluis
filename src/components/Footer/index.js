export default function Footer() {
  return (
   <footer className="flex flex-col justify-start">
    {/* Footer CTA */}
      <div className="flex flex-row justify-center self-center w-4/5 bg-blue-900 rounded-full p-4">
        <p className="text-white text-lg font-semibold mr-4">Trek van het scrollen?</p>
      ...
      <div className="flex flex-col justify-start items-start text-white pl-4">
        <p className="text-lg font-semibold py-2 tracking-wider">Adresgegevens</p>
      ...
      <div className="flex flex-col justify-start items-start text-white pl-4">
        <p className="text-lg font-semibold py-2 tracking-wider">Openingstijden</p>
      ...
      {/* Footer informatie */}
      <div className="flex flex-col justify-start items-start text-white pl-4">
        <p className="text-lg font-semibold py-2 tracking-wider">Informatie</p>
        <div className="flex flex-row w-3/5 md:w-full">
      ...
      <div className="bg-black text-lg text-white font-bold text-center p-3 mt-4">
        &copy; Cafetaria de Sluis
      </div>
    </footer>
  );
}
